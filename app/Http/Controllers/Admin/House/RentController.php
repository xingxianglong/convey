...
use App\Rules\Admin\House\Rent as RulesRent;
...
class RentController extends BaseController
{
    ...
    {
        return view('Admin/House/Rent/Index');
    }
    ...
    public function Form($jump_type,$id=0)
    {
        ...
        return view('/Admin/House/Rent/Form',$data);
    }
     ...
     * @param $validator
     */
    public function Add(Request $request,RulesRent $validator)
    {
        ...
        $min_price = $all['min_price']; //最小金额
        $max_price = $all['max_price']; //最大金额
     ...
     * @param $validator
     */
    public function Edit(Request $request,RulesRent $validator)
    {
     ...
     * @param $validator
     */
    public function Delete(Request $request,RulesRent $validator)
    {
