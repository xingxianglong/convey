...
<div class="admin-main">
        ...
        <div class="layui-col-xs11">
            <div class="grid-demo grid-demo-bg1">
                ...
                <div class="layui-inline select-input">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="administrator_name" autocomplete="off" placeholder="请输入管理员名称" class="layui-input">
                    </div>
                </div>
    ...
    <script type="text/html" id="barDemo">
        ...
        <a class="layui-btn layui-btn-xs layui-btn-normal" data-id="@{{d.id}}" lay-event="editAccount">重置账号</a>
...
layui.use(['table','laydate','form'] , function(){
    var table = layui.table
            ...
            , editUrl = '{{"Form/2"}}' //修改路径
            , editAccountUrl = '{{"FormAccount"}}' //重置账号路径
    ...
    table.render({
        ...
        ,cols: [[ //标题栏
            ...
            ,{field: 'administrator_name', title: '管理员名称',minWidth:100}
            ,{field: 'role_name', title: '职位',minWidth:100}
            ,{field: '', title: '头像',width:130,templet:function(d){
                var str = '<img src="'+ d.head +'" style="" />';
                return str;
            }}
            ,{field: 'phone', title: '手机号码',width:120}
            ,{field: 'email', title: '电子邮箱',minWidth:100}
            ,{field: '', title: '性别',width:60,templet:function(d){
                var str = '';
                if(d.sex == 1){
                    str = '男';
                }else if(d.sex == 2){
            ...
            ,{fixed: 'right', align:'center', toolbar: '#barDemo', title: '操作',width:190}
        ]]
        //,data: data
        // ,skin: 'line' //表格风格
        ,even: false
        ...
        ,done:function(res, curr, count) {
            $('.laytable-cell-1-0-4').click('on', function () {
                var that = $(this);
