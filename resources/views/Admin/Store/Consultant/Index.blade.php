        ...
        <div class="layui-col-xs11">
            <div class="grid-demo grid-demo-bg1">
                ...
                <div class="layui-inline select-input">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="consultant_name" autocomplete="off" placeholder="请输入顾问姓名" class="layui-input">
                    </div>
                </div>
...
layui.use(['table','laydate','form'] , function(){
    ...
    table.render({
        ...
        ,cols: [[ //标题栏
            ...
            ,{field: 'store_name', title: '门店',minWidth:100}
            ,{field: 'user_name', title: '绑定用户',minWidth:100}
            ,{field: 'consultant_name', title: '顾问姓名',minWidth:100}
            ,{field: 'position_name', title: '职位',minWidth:100}
            ...
            ,{field: 'induction_date', title: '入职日期',width:120}
        ...
        ,done:function(res, curr, count) {
            $('.laytable-cell-1-0-6').click('on', function () {
                var that = $(this);
