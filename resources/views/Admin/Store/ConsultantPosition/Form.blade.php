        ...
        <div class="layui-col-md12">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="position_name" value="{{isset($info->position_name)?$info->position_name:''}}" autocomplete="off" placeholder="请输入职位名称" class="layui-input">
                </div>
            </div>
...
layui.use(['form', 'layedit', 'laydate','upload','element','table'], function(){
    ...
    form.on('submit(demo1)', function(data){
        ...
        if(jump_type == 1)
        {
            url = '{{"/Admin/Store/ConsultantPosition/Add"}}';
        }
        else if(jump_type == 2)
        {
            url = '{{"/Admin/Store/ConsultantPosition/Edit"}}';
        }
        else
        {
        ...
        $.ajax({
            ...
            data:{
                id:id,
                position_name:data.field.position_name,
