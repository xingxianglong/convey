    ...
    <div class="layui-row layui-col-space10">
        <div class="layui-col-md12">
            <div class="layui-form-item">
                <label class="layui-form-label"><span style="color:red;">*</span>最小金额：</label>
                <div class="layui-input-block">
                    <input type="text" name="min_price" value="{{isset($info->min_price)?$info->min_price:''}}" autocomplete="off" placeholder="请输入最小金额" class="layui-input">
                </div>
            </div>

            <div class="layui-form-item">
                <label class="layui-form-label"><span style="color:red;">*</span>最大金额：</label>
                <div class="layui-input-block">
                    <input type="text" name="max_price" value="{{isset($info->max_price)?$info->max_price:''}}" autocomplete="off" placeholder="请输入最大金额" class="layui-input">
                </div>
            </div>
...
layui.use(['form', 'layedit', 'laydate','upload','element','table'], function(){
    ...
    form.on('submit(demo1)', function(data){
        ...
        if(jump_type == 1)
        {
            url = '{{"/Admin/House/Rent/Add"}}';
        }
        else if(jump_type == 2)
        {
            url = '{{"/Admin/House/Rent/Edit"}}';
        }
        else
        {
