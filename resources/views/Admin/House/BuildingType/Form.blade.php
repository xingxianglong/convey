        ...
        <div class="layui-col-md12">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="type_name" value="{{isset($info->type_name)?$info->type_name:''}}" autocomplete="off" placeholder="请输入建筑类型" class="layui-input">
                </div>
            </div>
...
layui.use(['form', 'layedit', 'laydate','upload','element','table'], function(){
    ...
    form.on('submit(demo1)', function(data){
        ...
        if(jump_type == 1)
        {
            url = '{{"/Admin/House/BuildingType/Add"}}';
        }
        else if(jump_type == 2)
        {
            url = '{{"/Admin/House/BuildingType/Edit"}}';
        }
        else
        {
