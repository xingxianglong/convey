    ...
    <div class="layui-row layui-col-space10">
        <div class="layui-col-md12">
            <div class="layui-form-item">
                <label class="layui-form-label"><span style="color:red;">*</span>公寓名称：</label>
                <div class="layui-input-block">
                    <input type="text" name="apartment_name" value="{{isset($info->apartment_name)?$info->apartment_name:''}}" autocomplete="off" placeholder="请输入公寓名称" class="layui-input">
                </div>
            </div>
...
layui.use(['form', 'layedit', 'laydate','upload','element','table'], function(){
    ...
    form.on('submit(demo1)', function(data){
        ...
        if(jump_type == 1)
        {
            url = '{{"/Admin/House/BrandApartment/Add"}}';
        }
        else if(jump_type == 2)
        {
            url = '{{"/Admin/House/BrandApartment/Edit"}}';
        }
        else
        {
        ...
        $.ajax({
            ...
            data:{
                id:id,
                apartment_name:data.field.apartment_name,
