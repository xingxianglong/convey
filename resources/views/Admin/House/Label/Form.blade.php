        ...
        <div class="layui-col-md12">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="label_name" value="{{isset($info->label_name)?$info->label_name:''}}" autocomplete="off" placeholder="请输入标签名称" class="layui-input">
                </div>
            </div>
...
layui.use(['form', 'layedit', 'laydate','upload','element','table'], function(){
    ...
    form.on('submit(demo1)', function(data){
        ...
        if(jump_type == 1)
        {
            url = '{{"/Admin/House/Label/Add"}}';
        }
        else if(jump_type == 2)
        {
            url = '{{"/Admin/House/Label/Edit"}}';
        }
        else
        {
        ...
        $.ajax({
            ...
            data:{
                id:id,
                label_name:data.field.label_name,
