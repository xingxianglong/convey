    ...
    <div class="layui-row layui-col-space10">
        <div class="layui-col-md12">
            <div class="layui-form-item">
                <label class="layui-form-label"><span style="color:red;">*</span>朝向名称：</label>
                <div class="layui-input-block">
                    <input type="text" name="direction_name" value="{{isset($info->direction_name)?$info->direction_name:''}}" autocomplete="off" placeholder="请输入朝向名称" class="layui-input">
                </div>
            </div>
...
layui.use(['form', 'layedit', 'laydate','upload','element','table'], function(){
    ...
    form.on('submit(demo1)', function(data){
        ...
        if(jump_type == 1)
        {
            url = '{{"/Admin/House/Direction/Add"}}';
        }
        else if(jump_type == 2)
        {
            url = '{{"/Admin/House/Direction/Edit"}}';
        }
        else
        {
        ...
        $.ajax({
            ...
            data:{
                id:id,
                direction_name:data.field.direction_name,
