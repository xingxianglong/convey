    ...
    <div class="layui-row layui-form">
        <div class="layui-col-xs11">
            <div class="grid-demo grid-demo-bg1">
                ...
                <div class="layui-inline select-input">
                    <label class="layui-form-label">朝向名称</label>
                    <div class="layui-input-inline">
                        <input type="text" name="direction_name" autocomplete="off" placeholder="请输入朝向名称" class="layui-input">
                    </div>
                </div>
            </div>
        </div>
...
layui.use(['table','laydate','form'] , function(){
    ...
    table.render({
        ...
        ,cols: [[ //标题栏
            ...
            ,{field: 'direction_name', title: '朝向名称',minWidth:100}
