        ...
        <div class="layui-col-md6">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="classify_name" value="{{isset($info->classify_name)?$info->classify_name:''}}" autocomplete="off" placeholder="请输入分类名称" class="layui-input">
                </div>
            </div>
...
layui.use(['form', 'layedit', 'laydate','upload','element','table'], function(){
    ...
    form.on('submit(demo1)', function(data){
        ...
        if(jump_type == 1)
        {
            url = '{{"/Admin/House/Classify/Add"}}';
        }
        else if(jump_type == 2)
        {
            url = '{{"/Admin/House/Classify/Edit"}}';
        }
        else
        {
        ...
        $.ajax({
            ...
            data:{
                id:id,
                classify_name:data.field.classify_name,
