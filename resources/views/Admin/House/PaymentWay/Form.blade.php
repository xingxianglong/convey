        ...
        <div class="layui-col-md12">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="way_name" value="{{isset($info->way_name)?$info->way_name:''}}" autocomplete="off" placeholder="请输入付款方式" class="layui-input">
                </div>
            </div>
...
layui.use(['form', 'layedit', 'laydate','upload','element','table'], function(){
    ...
    form.on('submit(demo1)', function(data){
        ...
        if(jump_type == 1)
        {
            url = '{{"/Admin/House/PaymentWay/Add"}}';
        }
        else if(jump_type == 2)
        {
            url = '{{"/Admin/House/PaymentWay/Edit"}}';
        }
        else
        {
