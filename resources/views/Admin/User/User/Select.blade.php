        ...
        <div class="layui-col-xs11">
            <div class="grid-demo grid-demo-bg1">
                ...
                <div class="layui-inline select-input">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="user_name" autocomplete="off" placeholder="请输入用户姓名" class="layui-input">
                    </div>
                </div>
            </div>
        </div>
...
layui.use(['table','laydate','form'] , function(){
    var table = layui.table
            ...
            , $ = layui.jquery
            , dateSelect = ''
            , getPageUrl = '{{"/Admin/User/User/GetPage"}}' //分页数据路径
    ...
    table.render({
        ...
        ,cols: [[ //标题栏
            ...
            ,{field: 'user_code', title: '编号',width:100}
            ,{field: 'user_name', title: '用户名称',minWidth:120}
            ,{field: '', title: '头像',width:130,templet:function(d){
                    var str = '<img src="'+ d.head +'" style="" />';
                    return str;
                }}
            ,{field: 'create_time', title: '注册时间',width:170}
        ]]
        //,data: data
        // ,skin: 'line' //表格风格
        ,even: false
